...
def get_quote():
    # todo add more...
    # Don't mind the extra long lines.
    quotes = [
...
def cleanup_file():
    ...
    # todo do it when user presses 0, clean up today's file.
    # Is it even a good idea? What if someone posts ASCII art and it gets destroyed by this?
    pass
